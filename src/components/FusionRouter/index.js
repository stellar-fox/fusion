...
import { action as FusionRouterAction } from "../../redux/FusionRouter"
...
export const StaticRouter = connect(
    ...
    (dispatch) => bindActionCreators({
        addStaticPaths: FusionRouterAction.addStaticPaths,
        getStatics: FusionRouterAction.getStatics,
        push,
    }, dispatch)
)(
    class extends Component {
        ...
        static getView = (path, map) =>
            path in map ? map[path] : string.empty()
...
// <FusionRouter> component
export const FusionRouter =
